...
![PyLint](https://img.shields.io/badge/PyLint-10.00/10-blue) [![CodeQL](https://github.com/beaver-ai/template-py-rest-microservice/actions/workflows/codeql.yml/badge.svg)](https://github.com/beaver-ai/template-py-rest-microservice/actions/workflows/codeql.yml) ![License](https://img.shields.io/badge/License-MIT-blue)
